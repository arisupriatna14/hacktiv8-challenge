...
/*
Algoritma:
1. lakukan sort manual pada "numbers"
2. buat variable baru dengan nama max dengan nilai "numbers" index terakhir
3. buat variable baru lagi dengan nama min dengan nilai 'numbers' index ke 0
4. lakukan iterasi pada numbers
  4a. jika index i kurang dari "numbers" index ke 1, maka index i dipush ke variable 'resultHasil'. jika tidak memenuhi,maka masuk step 4b.
  4b. jika index i lebih dari numbers index ke 1 && index i kurang dari max, maka index i dipush ke variable 'resultHasil'.
5. kembalikan nilai "resultHasil"
*/
